        ...
        if TaskExecution == False:
            if any(queries.startswith(func) for func in functions):
                if "focus mode" in queries:
                    ...
                    print(f"{Username} : {confirmation_query}")
